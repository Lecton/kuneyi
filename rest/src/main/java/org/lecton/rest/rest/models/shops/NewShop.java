...
public class NewShop  {
	...
	public NewShop(String shopName, String shopCategory, String shopArea, String shopAddress, String shopEmail,
			String shopTelephone, String shopFax, int shopRating, float shopLatitude, float shopLongitude) {
		super();
